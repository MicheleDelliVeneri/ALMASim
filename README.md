...
[![Documentation](https://readthedocs.org/projects/almasim/badge/?version=latest)](https://almasim.readthedocs.io/en/latest/)
...
Full reference: [Simulation docs](https://almasim.readthedocs.io/en/latest/simulation.html)
...
Full reference: [Skymodels docs](https://almasim.readthedocs.io/en/latest/skymodels.html)
...
Full reference: [Compute docs](https://almasim.readthedocs.io/en/latest/compute.html)
...
Full reference: [Metadata docs](https://almasim.readthedocs.io/en/latest/metadata.html) · [Downloads docs](https://almasim.readthedocs.io/en/latest/downloads.html)
...
Full reference: [Frontend docs](https://almasim.readthedocs.io/en/latest/frontend.html)
...
Full documentation: **[almasim.readthedocs.io](https://almasim.readthedocs.io)**

| Section | Topics |
|---|---|
| [Quick Start](https://almasim.readthedocs.io/en/latest/quickstart.html) | Installation, first simulation |
| [Simulation](https://almasim.readthedocs.io/en/latest/simulation.html) | Staged API, SimulationParams, outputs |
| [Interferometry](https://almasim.readthedocs.io/en/latest/interferometry.html) | UV sampling, baselines, multi-config |
| [Noise](https://almasim.readthedocs.io/en/latest/noise.html) | PWV-aware noise model |
| [Background Sky](https://almasim.readthedocs.io/en/latest/background.html) | Additive astrophysical background |
| [Skymodels](https://almasim.readthedocs.io/en/latest/skymodels.html) | Source models reference |
| [Imaging](https://almasim.readthedocs.io/en/latest/imaging.html) | Deconvolution, TP+INT combination |
| [Metadata](https://almasim.readthedocs.io/en/latest/metadata.html) | TAP queries, filters |
| [Downloads](https://almasim.readthedocs.io/en/latest/downloads.html) | Product download workflow |
| [Compute Backends](https://almasim.readthedocs.io/en/latest/compute.html) | Sync, Dask, Slurm, Kubernetes |
| [Frontend](https://almasim.readthedocs.io/en/latest/frontend.html) | Svelte UI workflows |
