...
def return_random_molecular_cloud(imsize=256, powerlaw=None, ellip=None):
    ...
    print(f"Returning image with imsize={imsize} powerlawindex={powerlaw:.3}, theta={theta:.3} and ellip={ellip:.3}")
    
    im = make_extended(imsize, powerlaw=powerlaw, theta=theta, ellip=ellip, randomseed = random.randrange(10000))
