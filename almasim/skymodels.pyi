...
class myTNGSource(SPHSource):
    def __init__(self, snapNum, subID, basePath: Incomplete | None = None, distance=..., vpeculiar=..., rotation=..., ra=..., dec=..., api_key: Incomplete | None = None) -> None: ...
...
class DataCube:
    ...
    padx: int
    pady: int
    def __init__(self, n_px_x: int = 256, n_px_y: int = 256, n_channels: int = 64, px_size=..., channel_width=..., velocity_centre=..., ra=..., dec=..., stokes_axis: bool = False) -> None: ...
...
class Martini:
    ...
    inserted_mass: int
    def __init__(self, source: Incomplete | None = None, datacube: Incomplete | None = None, beam: Incomplete | None = None, noise: Incomplete | None = None, sph_kernel: Incomplete | None = None, spectral_model: Incomplete | None = None, quiet: bool = False, find_distance: bool = False) -> None: ...
    def convolve_beam(self) -> None: ...
    def add_noise(self) -> None: ...
    def insert_source_in_cube(self, skip_validation: bool = False, progressbar: Incomplete | None = None, ncpu: int = 1): ...
    def write_fits(self, filename, channels: str = 'frequency', overwrite: bool = True) -> None: ...
    def write_beam_fits(self, filename, channels: str = 'frequency', overwrite: bool = True) -> None: ...
    def write_hdf5(self, filename, channels: str = 'frequency', overwrite: bool = True, memmap: bool = False, compact: bool = False): ...
    def reset(self) -> None: ...
...
def sample_positions(terminal, pos_x, pos_y, pos_z, fwhm_x, fwhm_y, fwhm_z, n_components, fwhm_xs, fwhm_ys, fwhm_zs, xy_radius, z_radius, sep_xy, sep_z): ...
def insert_serendipitous(terminal, update_progress, datacube, continum, cont_sens, line_fluxes, line_names, line_frequencies, freq_sup, pos_zs, fwhm_x, fwhm_y, fwhm_zs, n_px, n_chan, sim_params_path): ...
def get_datacube_header(datacube, obs_date): ...
def write_datacube_to_fits(datacube, filename, obs_date, channels: str = 'frequency', overwrite: bool = True) -> None: ...
