...
class DownloadTNGStructureRunnable(QRunnable, metaclass=_PyQtWrapperType):
...
class DownloadHubbleRunnable(QRunnable, metaclass=_PyQtWrapperType):
    """Runnable for downloading TNG Folders in a separate thread."""
...
class PlotResultsRunnable(QRunnable, metaclass=_PyQtWrapperType):
    """Runnable for plotting simulation results in a separate thread."""

    alma_simulator: Incomplete  # Note: This should be "ALMASimulator"
    simulation_results: Incomplete
    def __init__(self, alma_simulator_instance, simulation_results) -> None: ...
    def run(self) -> None: ...
...
class ALMASimulator(QMainWindow, metaclass=_PyQtWrapperType):
    ...
    @classmethod
    def populate_class_variables(cls, terminal, ncpu_entry, thread_pool) -> None: ...
    ...
    def browse_hubble_directory(self) -> None: ...
    ...
    def download_hubble(self) -> None: ...
    def download_hubble_on_remote(self) -> None: ...
    ...
    def show_background_notification(self) -> None: ...
    def start_plot_runnable(self, simulation_results) -> None: ...
    ...
    def run_next_simulation(self) -> None: ...
