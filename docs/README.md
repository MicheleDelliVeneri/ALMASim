...
This directory contains focused markdown documentation for the main ALMASim subsystems.
...
- [Noise](noise.md)
- [Background Sky](background.md)
- [Skymodels](skymodels.md)
...
2. [Skymodels](skymodels.md)
3. [Interferometry](interferometry.md)
4. [Noise](noise.md)
5. [Background Sky](background.md)
6. [Imaging and Combination](imaging.md)
