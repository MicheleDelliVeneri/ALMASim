...
def freq_supp_extractor(
    freq_sup: str, obs_freq: U.Quantity
) -> Tuple[U.Quantity, U.Quantity, int, U.Quantity]:
    """
    ...
    ----------
    freq_sup : str
        Frequency support string in the form
        "[freq_min..freq_maxGHz,delta_freqkHz,...] U [...]"
    obs_freq : U.Quantity
